...
cfg.num_vals = 6 # optionally, we can try multiple values of certain parameter in single simulation by having N unconnected cells, and each of which getting different value (implemente in init.py and/or netParams.py)
